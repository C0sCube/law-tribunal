...
def run_all(ui):
    ...
    # Loop all 18 appeals automatically
    for appeal_index in range(1, 19):
        ...
        # Wait for Next Combo button (manual step control)
        ui.wait_for_next()

        # === Set bench (by value) and appeal (by index) ===
